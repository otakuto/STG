...
{
public:
	AnimationSprite(LPDIRECT3DDEVICE9 const &direct3DDevice, const std::vector<const LPDIRECT3DTEXTURE9> &texture, RECT const &range, D3DXVECTOR3 const&center, const bool additive, int const interval);
	~AnimationSprite();
